...
namespace GSB2
{
    ...
    public class ModelChecker : EditorWindow
    {
        ...
        void ApplyOptions(ModelImporter mi)
        {
            ...
            mi.importMaterials = _ImportMaterials;
        ...
        bool IsEqualOption(ModelImporter mi)
        {
            ...
            if( mi.optimizeMesh != _OptimizeMesh )
            {
                return false;
            }
            ...
            if( _ImportMaterials != mi.importMaterials )
            {
                return false;
            }
            else if( mi.importMaterials == true )
            {
