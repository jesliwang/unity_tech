...
namespace PathCreation.Examples
{
    public class RoadMeshCreator : PathSceneTool
    {
        ...
        public float textureTilingX = 1;
        public float textureTiling = 1;         //textureTilingY로 바꾸면 기존 작업물을 다 1로 덮어 써버림. 헬!!!! 바꾸지 마!!!!
        ...
        void AssignMaterials()
        {
            if (roadMaterial != null /*&& undersideMaterial != null*/)
            {
                ...
                if (meshRenderer.sharedMaterials[0].HasProperty("_WaveTile"))
                {
                    meshRenderer.sharedMaterials[0].SetFloat("_WaveTile", textureTiling);
                }
                else
                {
                    meshRenderer.sharedMaterials[0].mainTextureScale = new Vector3(textureTilingX, textureTiling);
                }
