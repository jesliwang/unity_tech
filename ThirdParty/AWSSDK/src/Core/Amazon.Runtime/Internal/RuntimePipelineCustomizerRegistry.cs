...
namespace Amazon.Runtime.Internal
{
    ...
    {
        /// Change for C# old style
        //public static RuntimePipelineCustomizerRegistry Instance { get; } = new RuntimePipelineCustomizerRegistry();
        public static RuntimePipelineCustomizerRegistry instance = new RuntimePipelineCustomizerRegistry();
        public static RuntimePipelineCustomizerRegistry Instance
        {
            get
            {
                if (instance == null)
                    instance = new RuntimePipelineCustomizerRegistry();
