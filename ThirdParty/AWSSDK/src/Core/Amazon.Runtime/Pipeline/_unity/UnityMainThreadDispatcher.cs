...
namespace Amazon.Runtime.Internal
{
    ...
    public class UnityMainThreadDispatcher : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            Type typeFromHandle = typeof(UnityWebRequestWrapper);   //:
            _unityWebRequestInstanceFieldInfo = typeFromHandle.GetField("unityWebRequestInstance", BindingFlags.Instance | BindingFlags.NonPublic); //:
        }
        ...
        {
            UnityWebRequest val = _unityWebRequestInstanceFieldInfo.GetValue(instance) as UnityWebRequest;
            val.chunkedTransfer = chunkedTransfer;
        }
