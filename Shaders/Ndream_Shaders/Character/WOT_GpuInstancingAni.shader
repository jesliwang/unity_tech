Shader "WOT/Character/WOT_GpuInstancingAni"
{
	Properties
	{	
		[Space(10)]
		...
		//_FlagIndex("FlagIndex", Range(-1, 1)) = 1  //인스턴싱용 좌우반전
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(Props)
				//UNITY_DEFINE_INSTANCED_PROP(float, _FlagIndex) //인스턴싱용 좌우반전
			...
			v2f vert (appdata v)
			{
				...
				v.vertex = pos; //그림자는 v.vertex를 그대로 가져다 씀. gpu instancing 연산치를 덮어줌
