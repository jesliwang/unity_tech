...
Shader "Hidden/WOT/FX/WOT_FX (TextureClip)"
{
    Properties
    {
		[Space(20)]
...
//				#pragma fragmentoption ARB_precision_hint_fastest 
				...
				#pragma multi_compile __ TEXTURE1
...
//#elif ALPHABLEND	//Alphablend
	...
	#endif
				//	Softness factor	-- additive, multiply가 srcAlpha를 안쓰기 때문에 분리
				half4 clip = tex2D(_ClipTex, i.clipUV);
				finalColor.a *= clip.r;
					...
					finalColor = mainTex * mainTex1 * mainTex2 * i.color;
	#endif
					//	Softness factor	-- SrcAlpha를 안쓰기 때문에 요렇게 수정
					half4 clip = tex2D(_ClipTex, i.clipUV);
					finalColor *= clip;
#endif
